...
export default function ExploreClient({
  ...
  return (
    <div className="fixed inset-0 bg-[color:var(--surface)]">
      {/* Top bar */}
      <div className="absolute top-0 left-0 right-0 z-30 flex items-center gap-3 md:gap-4 px-4 md:px-6 py-3 md:py-4 pointer-events-none">
        ...
        <div className="hidden md:flex items-center gap-4 flex-1">
          ...
          <div className="pointer-events-auto ml-2 flex-1 max-w-md">{searchBox}</div>
